...
Our journal paper, "A Deep Context Learning based PCB Defect Detection Model with Anomalous Trend Alarming System" has been accepted by the journal, Engineering Application of Artificial Intelligence (EAAI) and can be found [here](https://www.google.com/"target="_blank). 
